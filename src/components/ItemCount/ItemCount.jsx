    ...
    return (
        <div className="row">
            <div className="col-md-6 offset-md-3">
                <p><input type="button" className="btn fondo_naranja rounded-circle link_header" value="-" onClick={() => {decrementarCantidad(counter - 1)}} /> {counter} <input type="button" className="btn fondo_naranja rounded-circle link_header" value="+" onClick={() => {incrementarCantidad(counter + 1)}} /></p>
